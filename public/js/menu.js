...
var images = document.querySelectorAll(".menu-img"); // モーダル内要素取得

var modal_image = document.querySelector(".modal-menu-image");
var modal_menu_name = document.querySelector('[data-js="modalMenuName"]');
var modal_menu_desc = document.querySelector('[data-js="modalMenuDesc"]');
var modal_menu_price = document.querySelector('[data-js="modalMenuPrice"]');
var modal_menu_tax_in_price = document.querySelector('[data-js="modalMenuTaxInPrice"]'); // モーダル内要素ここまで
...
if (windowAvailWidth > ipadSidewaysWidth) {
  var calcTaxInPrice = function calcTaxInPrice(priceNum) {
    ...
    image.addEventListener("click", function () {
      ...
      for (var i = 0; i < menuData.length; i++) {
        if (image_id == menuData[i].id) {
          var menu_name = menuData[i].name;
          var menu_desc = menuData[i].desc;
          var menu_price = menuData[i].price;
